...
internal class SkillsInitializer : SkillsInitializerBase
{
    ...
    public override void Initialize()
    {
        ...
        this.AddAreaSkillSettings(SkillNumber.Decay, false, default, default, default, useTargetAreaFilter: true, targetAreaDiameter: 8, guaranteedTargets: 5, maximumTargets: 10, additionalTargetChance: 0.5f, randomDelayPerHitMaximum: TimeSpan.FromMilliseconds(500));
        ...
        this.AddAreaSkillSettings(SkillNumber.IceStorm, false, default, default, default, useTargetAreaFilter: true, targetAreaDiameter: 8, guaranteedTargets: 5, maximumTargets: 10, additionalTargetChance: 0.5f);
        ...
        this.AddAreaSkillSettings(SkillNumber.TwistingSlash, false, 0, 0, 0, guaranteedTargets: 10, maximumTargets: 15, additionalTargetChance: 0.5f, useCasterAsCenter: true, useEuclideanRange: true);
        ...
        this.AddAreaSkillSettings(SkillNumber.RagefulBlow, false, 0, 0, 0, guaranteedTargets: 10, maximumTargets: 15, additionalTargetChance: 0.5f, useCasterAsCenter: true, useEuclideanRange: true, delayPerHit: TimeSpan.FromMilliseconds(500));
        ...
        this.CreateSkill(SkillNumber.FireBurst, "Fire Burst", CharacterClasses.AllLords, DamageType.Physical, 100, 6, manaConsumption: 25, energyRequirement: 79, skillTarget: SkillTarget.ExplicitWithImplicitInRange, implicitTargetRange: 2);
        this.AddAreaSkillSettings(SkillNumber.FireBurst, false, 0, 0, 0, useEuclideanRange: true, randomDelayPerHitMinimum: TimeSpan.FromMilliseconds(500), randomDelayPerHitMaximum: TimeSpan.FromMilliseconds(799));
        ...
        this.AddAreaSkillSettings(SkillNumber.Earthshake, false, 0, 0, 0, guaranteedTargets: 10, maximumTargets: 15, additionalTargetChance: 0.5f, useCasterAsCenter: true, useEuclideanRange: true, delayPerHit: TimeSpan.FromMilliseconds(500));
        ...
        this.AddAreaSkillSettings(SkillNumber.LightningShock, false, 0, 0, 0, maximumHitsPerAttack: 12, guaranteedTargets: 5, maximumTargets: 12, additionalTargetChance: 0.5f, useCasterAsCenter: true, useEuclideanRange: true, delayPerHit: TimeSpan.FromMilliseconds(250));
        ...
        this.AddAreaSkillSettings(SkillNumber.StrikeofDestruction, false, 0, 0, 0, useTargetAreaFilter: true, targetAreaDiameter: 6, guaranteedTargets: 4, maximumTargets: 8, additionalTargetChance: 0.5f, useTargetAreaSquare: true, requireTargetAreaCenterInRange: true, delayPerHit: TimeSpan.FromMilliseconds(500));
